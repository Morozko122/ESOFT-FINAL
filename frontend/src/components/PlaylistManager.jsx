    ...
    <Box sx={{ padding: 2 }}>
          ...
          <ListItem key={playlist.Playlist.playlist_id} sx={{ marginBottom: 2 }}>
            <Card>
              <CardContent>
                ...
                <Button variant="outlined" onClick={() => handlePlaylistClick(playlist)} sx={{ marginRight: 1 }}>
                  View Content
                </Button>
                <Button variant="outlined" color="secondary" onClick={() => handleDeletePlaylist(playlist.Playlist.playlist_id)}>
                  Delete
      ...
      <Dialog open={selectedPlaylist !== null} onClose={() => setSelectedPlaylist(null)}>
        ...
        <DialogContent>
          <List>
            {playlistContent.map((content) => (
              <ListItem key={content.content_id} sx={{ marginBottom: 1 }}>
                <ListItemText primary={content.label} />
                <Button variant="outlined" component={Link} to={`/content/${content.content_id}`} sx={{ marginRight: 1 }}>
                  View Content
                </Button>
                <Button variant="outlined" color="secondary" onClick={() => handleRemoveContent(selectedPlaylist.Playlist.playlist_id, content.content_id)}>
                  Remove
